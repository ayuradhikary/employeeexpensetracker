...
<head>
    ...
    <title>Employee Expense Tracking System || Employee expense Report</title>
...
<body>
 ...
 <div class="panel panel-default">
                    <div class="panel-heading">Fill the info</div>
                    <div class="panel-body">
                        <p style="font-size:16px; color:red" align="center"> </p>
                        <div class="col-md-12">
                            
                            <form role="form" method="post" action="employeereport.php">
